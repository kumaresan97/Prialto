    ...
    return (
        <div className="card">
            <TreeTable value={nodes} tableStyle={{ minWidth: '50rem' }}>
                ...
                <Column field="size" header="Size" style={{ height: '3.5rem' }} 
                  body={(obj: any) =>test()}>
                  </Column>
